...
export default function NewColumn() {
	return (
		<div
			...
			className='w-[280px] align-self-stretch	  mt-16  text-2xl flex-shrink-0  rounded-lg  bg-gradient-to-b from-background cursor-pointer   to-secondaryBackground flex justify-center items-center space-y-10 text-text group '>
